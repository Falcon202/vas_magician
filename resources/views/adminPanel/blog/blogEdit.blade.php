    ...
    <div class="mainContent">
        ...
        <section class=" mySectionContainer">
            <div>
                ...
                <p class="mt-1 text-muted w-100">Úprava jednotlivých údajů tohoto blogu</p>
                ...
                <form class="form-card formCreateUser" action="{{ route('ap_blog_do_edit') }}" method="post">
                    @csrf
                            ...
                            <div data-mdb-input-init class="form-outline">
                                ...
                                <select id="category_id" name="category_id" required
                                    ...
                                    @foreach($categories as $oneCategory)
                                        <option
                                            value="{{$oneCategory->id}}" @if(old('category_id', $blog->category_id) == $oneCategory->id) selected @endif >{{$oneCategory->name}}</option>
                                    @endforeach
                                </select>
