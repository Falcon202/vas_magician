...
<section class="promo-container">
    <div class="mikromagie-info-container">
        <div class="mikromagie-info-container-text">
            <h2>individuální kouzelnické vystoupení</h2>
        </div>
    ...
    <div class="akceprodeti-text">
        <p>Kouzelnické vysoupení pro děti, kdy neodchází anin rodiče. Děti potřebují zažít, když jsou součástí vystoupení. I vás dospělé, kouzel ník Marinn vtáhnne do programu tatk, že nebudete moci odejít. Zážitek, kde se děly neuvěřitelnné věci a skutečná kouzla, budou děti vyprávět svým kamarádům úsměvem. Kouzelník Martin byl kamarád a už při příjezdu vykouzlí mince za uchem. "Přijeďte prosím ještě někdy"</p>
    </div>
</section>
<div class="bespoke-headline">
    <h3>spolupráce, kterých si vážím!</h3>
</div>
