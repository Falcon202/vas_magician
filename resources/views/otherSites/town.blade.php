...
<div class="gallery">
    <div class="item large" style="background-image: url('/images/akce-pro-deti-kouzelník-martin-kellman.webp')">
        <div class="text">
            <h3>Svatba Michala a Lucky</h3>
            <p>20. 7. 2024 / Praha / Park U Zamilovaných</p>
        </div>
    </div>
    <div class="item" style="background-image: url('/images/akce-pro-deti-kouzelník-martin-kellman.webp')">
        <div class="text">
            <h3>Dětský den v Kladně</h3>
            <p>8. 9. 2024 / Kladno / Showroom Kladno</p>
        </div>
    </div>
    <div class="item tall" style="background-image: url('/images/akce-pro-deti-kouzelník-martin-kellman.webp')">
        <div class="text">
            <h3>Dětská oslava v Říčanech</h3>
            <p>25. 7. 2024 / Říčany / Rodinný dům</p>
        </div>
    </div>
    <div class="item wide" style="background-image: url('/images/akce-pro-deti-kouzelník-martin-kellman.webp')">
        <div class="text">
