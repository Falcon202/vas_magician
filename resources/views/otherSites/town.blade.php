...
<body>
    ...
    <main>
        ...
        <div class="towns-main">
            <h4>kouzelník <span class="town-bold">Praha</span></h4>
            <h2>MARTIN KELLMAN</h2>
        </div>
        </div>
    ...
    <section class="another-blog">
        <button class="blog-arrow blog-arrow-left">
            <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
        ...
        <div class="another-blog-galery-wrapper">
            <div class="another-blog-container">

                <div class="another-blog-item">
                    <h3>Mikromagie v Praze</h3>
                    <p>10.8.2023 / Praha / Kongresový sál PraHO!</p>
                </div>
        ...
        <button class="blog-arrow blog-arrow-right">
            <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
                <path d="M721.7,73.9c-9.6-9.6-25.1-9.6-34.7,0l-408.3,408.3c-.2,0-.3.2-.5.4h0c-9.6,9.7-9.6,25.2,0,34.8l408.8,408.7c4.8,4.8,11.1,7.2,17.4,7.2s12.5-2.4,17.3-7.2c9.6-9.6,9.6-25.2,0-34.7l-391.3-391.4L721.7,108.6c9.6-9.6,9.6-25.1,0-34.7Z"/>
            </svg>
        </button>
    ...
    <section class="single-blog-photogalery">
        <div class="single-blog-text">
            <h4>Nádherný den, kdy se dvě duše spojily v kouzelném obřadu, a my jsme byli svědky něčeho opravdu magického. Michal a Lucka si řekl "ano" v okouzlujícím prostředí, kde nechyběla ani špetka tajemsví a kouzla.</h4>
        </div>
    </section>
    <section class="towns">
    ...
    <div class="gallery">
        <div class="item large" style="background-image: url('{{ asset('images/akce-pro-deti-kouzelnik-martin-kellman.webp') }}')">
            <div class="text">
                <div class="blog-corner-badge">
                    <svg class="blog-icon" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1000 1000">
                        <!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 1.2.0 Build 709)  -->
                ...
                <h3>Svatba Michala a Lucky</h3>
                <p>20. 7. 2024 / Praha / Park U Zamilovaných</p>
            </div>
        </div>
        <div class="item" style="background-image: url('{{ asset('images/akce-pro-deti-kouzelnik-martin-kellman.webp') }}')">
            <div class="text">
                <div class="blog-corner-badge">
                    <svg class="blog-icon" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1000 1000">
                        <!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 1.2.0 Build 709)  -->
                ...
                <h3>Dětský den v Kladně</h3>
                <p>8. 9. 2024 / Kladno / Showroom Kladno</p>
            </div>
        </div>
        <div class="item tall" style="background-image: url('{{ asset('images/akce-pro-deti-kouzelnik-martin-kellman.webp') }}')">
            <div class="text">
                <div class="blog-corner-badge">
                    <svg class="blog-icon" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1000 1000">
                        <!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 1.2.0 Build 709)  -->
                ...
                <h3>Dětská oslava v Říčanech</h3>
                <p>25. 7. 2024 / Říčany / Rodinný dům</p>
            </div>
        </div>
        <div class="item wide" style="background-image: url('{{ asset('images/akce-pro-deti-kouzelnik-martin-kellman.webp') }}')">
            <div class="text">
                <div class="blog-corner-badge">
                    <svg class="blog-icon" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1000 1000">
                        <!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 1.2.0 Build 709)  -->
                ...
                <h3>Kouzelná show v Liberci</h3>
                <p>20. 6. 2024 / Liberec / Liberecká showroom</p>
            </div>
        </div>
    </div>
    </div>
    ...
    <div class="mid-button">
        <button id="show-more-faq" class="third-button">+ zobrazit další akce</button>
        <button style="margin-top: 15px;" class="rounded-button">
            <div class="button-content">
                <span>objednat</span>
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1000 1000">
                    <!-- Generator: Adobe Illustrator 28.6.0, SVG Export Plug-In . SVG Version: 1.2.0 Build 709)  -->
