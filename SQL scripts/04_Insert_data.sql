...
INSERT INTO `Blog` (`id`, `name`, `date`, `city_id`, `location2`, `text`, `category_id`, `is_disabled`) VALUES
(1,	'Svatba Michala a Lucky',	'2024-07-20',	1,	'Park u zamilovaných',	'Podrobný popis ohledně proběhlé akce',	2, 0),
(2,	'Dětský den v Kladně',	'2024-09-08',	2,	'Showroom Kladno',	'Podrobný popis ohledně proběhlé akce',	1, 0),
(3,	'Dětská oslava v Říčanech',	'2024-07-25',	3,	'Rodinný dům',	'Podrobný popis ohledně proběhlé akce',	1, 0),
(4,	'Kouzelná show v Liberci',	'2024-06-20',	4,	'Liberecká showroom',	'Podrobný popis ohledně proběhlé akce',	1, 0),
(5,	'Firemní večírek v Brně',	'2024-03-13',	5,	'Multifunkční sál Brňák',	'Podrobný popis ohledně proběhlé akce',	3, 0),
(6,	'Svatba Lukáše a Elišky',	'2024-10-03',	6,	'Statek Krásná svatba',	'Podrobný popis ohledně proběhlé akce',	2, 0),
(7,	'Kouzelná show v exteriéru',	'2024-08-01',	7,	'Karlovská ulice',	'Podrobný popis ohledně proběhlé akce',	4, 0),
(8,	'Firemní večírek Praha',	'2024-04-06',	1,	'Kongresový sál Pražanda',	'Podrobný popis ohledně proběhlé akce',	3, 0),
(9,	'firemní oslava Teplice',	'2024-04-14',	8,	'Firma teplický',	'Podrobný popis ohledně proběhlé akce',	3, 0)
;
